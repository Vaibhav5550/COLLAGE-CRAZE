package com.event.collegecraze.PaymentFiles;
...
import com.event.collegecraze.AddPaymentActivity;
...
//    String salt="ZhraT96O"; // live
    ...
    String merchant_key="ErleptqG"; // test
    String salt="KFRsYotawx"; // test
    String action1 ="";
            ...
            mHandler.post(new Runnable() {
                public void run() {
                    mHandler = null;
                     ...
                     finish();*/
                    // new PostRechargeData().execute();
                    Intent intent=new Intent(PayMentGateWay.this, AddPaymentActivity.class);
