...
public class Utils
{
    public static final String AEMAIL = "festivalhub1234@gmail.com";
    public static final String APASSWORD = "festivalhub@123";
    ...
    public static final String OTPSUBJECT = "OTP confirmation alert for your account";
